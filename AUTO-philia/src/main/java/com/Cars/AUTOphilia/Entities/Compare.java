...
public class Compare {
	...
	public Compare(long acarid, String abrand, int acolors, String adescription, int aenginetypes, String aimage,
	...
	public Compare(Cars car) {
		super();
		this.acarid = car.getAcarid();
		this.aname = car.getAname();
		this.aimage = car.getAimage();
		this.abrand = car.getAbrand();
		this.amodel = car.getAname();
		this.aprice = car.getAprice();
		this.atransmission = car.getAtransmission();
		this.acolors = car.getAcolors();
		this.aenginetypes = car.getAenginetypes();
		this.adescription = car.getAdescription();
